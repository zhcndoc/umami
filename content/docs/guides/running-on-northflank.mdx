...
[![部署到 Northflank](https://assets.northflank.com/deploy_to_northflank_smm_36700fb050.svg)](https://northflank.com/stacks/deploy-umami)
...
3. Create a **Deployment service** using the Docker image `docker.umami.is/umami-software/umami:postgresql-latest`.
