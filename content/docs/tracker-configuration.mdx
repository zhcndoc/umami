...
Each value matches against `window.location.hostname`, so you should double check if your website uses `www` or not.
<br/>Helps if you are working in a staging/development environment. <br/>
