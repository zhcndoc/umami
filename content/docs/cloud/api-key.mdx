...
The region will default to the region of the Account that owns the API-KEY. You can specify the region by addiing the region to the API call as the first path.
