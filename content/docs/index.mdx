---
title: Overview
description: Welcome to the Umami v3 documentation!
---
...
1. [Log into the application](/docs/login)
1. [Add a website](/docs/add-a-website)
1. [Add the tracking code into your website HTML](/docs/collect-data)
